...
The control is now configured to build an ocx. The old test form is now in ucExplorerTestApp.twinproj. Corrected the version info failure bug making the control think it was on XP. 
